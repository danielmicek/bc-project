...
const CookieConsent = React.forwardRef((
  {
    ...
    onDeclineCallback = () => {},
    className,
    description = "Táto stránka používa nevyhnutné cookies na prihlásenie a bezpečnosť účtu.",
    learnMoreHref = "#",
    ...props
  },
  ref,
      ...
      <div {...commonWrapperProps}>
        <Card className="m-3 shadow-lg">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-lg">Používame cookies</CardTitle>
      ...
      <div {...commonWrapperProps}>
        <Card className="m-3 shadow-lg">
          <CardHeader
            ...
            <CardTitle className="text-base">Používame cookies</CardTitle>
